...
int main() {
    ...
    create_and_add_instruction(i_list, INST_JMP, inter_table_get_var(sym_tab, 50), 0,
                               0);                //preskocenie definicie funkcie
    ...
    create_and_add_instruction(i_list, INST_PUSH, inter_table_get_var(sym_tab, 0), 0,
                               0);                 //lokalna premenna
    create_and_add_instruction(i_list, INST_ADD, inter_table_get_var(sym_tab, 25), inter_table_get_var(sym_tab, 30),
                               inter_table_get_var(sym_tab, 31));
    create_and_add_instruction(i_list, INST_WRITE, inter_table_get_var(sym_tab, 25), 0, 0);
    create_and_add_instruction(i_list, INST_RET, inter_table_get_var(sym_tab, 2), 0,
                               0);                  //koniec funkcie
    ...
    create_and_add_instruction(i_list, INST_PUSH, inter_table_get_var(sym_tab, 6), 0,
                               0);                 //predavanie premennych hodnotov
    create_and_add_instruction(i_list, INST_CALL, inter_table_get_var(sym_tab, 100), 0,
                               0);                 //volanie funkcie
    ...
    create_and_add_instruction(i_list, INST_PUSH, inter_table_get_var(sym_tab, 9), 0,
                               0);                 //predavanie premennych hodnotov
    create_and_add_instruction(i_list, INST_CALL, inter_table_get_var(sym_tab, 100), inter_table_get_var(sym_tab, 19),
                               0);                 //volanie funkcie
    create_and_add_instruction(i_list, INST_POP, 0, 0, 0);
    create_and_add_instruction(i_list, INST_POP, 0, 0, 0);
    ...
    create_and_add_instruction(i_list, INST_WRITE, inter_table_get_var(sym_tab, 2), 0,
                               0);                    //vypisanie premennej v tabulke symbolov
    ...
    create_and_add_instruction(i_list, INST_SUB, inter_table_get_var(sym_tab, 10), inter_table_get_var(sym_tab, 6),
                               inter_table_get_var(sym_tab, 3));
    create_and_add_instruction(i_list, INST_WRITE, inter_table_get_var(sym_tab, 10), 0, 0);

    create_and_add_instruction(i_list, INST_MUL, inter_table_get_var(sym_tab, 10), inter_table_get_var(sym_tab, 6),
                               inter_table_get_var(sym_tab, 3));
    create_and_add_instruction(i_list, INST_WRITE, inter_table_get_var(sym_tab, 10), 0, 0);

    create_and_add_instruction(i_list, INST_DIV, inter_table_get_var(sym_tab, 10), inter_table_get_var(sym_tab, 6),
                               inter_table_get_var(sym_tab, 4));
    create_and_add_instruction(i_list, INST_WRITE, inter_table_get_var(sym_tab, 10), 0, 0);
