...
*/
    ...
    create_and_add_instruction(i_list, INST_ADD, inter_table_get_var(inter_tab,LOCAL_C), inter_table_get_var(inter_tab,ARG_A), inter_table_get_var(inter_tab,ARG_B));
    ...
    create_and_add_instruction(i_list, INST_JZ, inter_table_get_var(inter_tab,OVER_RECURSION), inter_table_get_var(inter_tab,LOCAL_C), 0);
