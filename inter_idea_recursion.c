...
*/
    ...
    tmp_var.data.i = -3;
    inter_table_add_var(ARG_A, &tmp_var, sym_tab);
    tmp_var.arg_type = STACK_EBP;
    tmp_var.data.i = -2;
    inter_table_add_var(ARG_B, &tmp_var, sym_tab);
    ...
    inter_table_add_var(ADD, &tmp_var, sym_tab);
    ...
    tmp_var.arg_type = INSTRUCTION;
    tmp_var.data.instruction = ptr_inst;
    inter_table_add_var(OVER_RECURSION, &tmp_var, sym_tab);
